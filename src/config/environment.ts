...
export const ENV = {
  ...
  ENABLE_INVITATION: process.env.ENABLE_INVITATION === undefined ? true : process.env.ENABLE_INVITATION === 'true',
  REQUIRE_REGISTRATION_VERIFICATION: process.env.REQUIRE_REGISTRATION_VERIFICATION === undefined ? true : process.env.REQUIRE_REGISTRATION_VERIFICATION === 'true',
  GOOGLE_CLIENT_ID: process.env.GOOGLE_CLIENT_ID,
  GOOGLE_CLIENT_SECRET: process.env.GOOGLE_CLIENT_SECRET,
  GOOGLE_REDIRECT_URI: process.env.GOOGLE_CALLBACK_URL || process.env.GOOGLE_REDIRECT_URI,
  DISCORD_CLIENT_ID: process.env.DISCORD_CLIENT_ID,
  DISCORD_CLIENT_SECRET: process.env.DISCORD_CLIENT_SECRET,
  DISCORD_REDIRECT_URI: process.env.DISCORD_REDIRECT_URI,
  YANDEX_CLIENT_ID: process.env.YANDEX_CLIENT_ID,
  YANDEX_CLIENT_SECRET: process.env.YANDEX_CLIENT_SECRET,
  YANDEX_REDIRECT_URI: process.env.YANDEX_CALLBACK_URL || process.env.YANDEX_REDIRECT_URI,
